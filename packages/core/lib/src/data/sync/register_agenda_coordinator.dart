...
class RegisterAgendaCoordinator {
  ...
  List<AgendaEventDraft> _desiredDoses(RegisteredEvent event) {
    ...
    if (explicitEnd != null && next.isAfter(explicitEnd)) return const [];
    ...
    // Una pauta es una serie, no cientos de eventos de agenda. Conservamos
    // exclusivamente su siguiente ocurrencia; la reconciliación reemplaza la
    // fecha cuando corresponda y elimina las ocurrencias antiguas derivadas.
